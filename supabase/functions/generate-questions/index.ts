...
serve(async (req) => {
  ...
  try {
    ...
    let prompt = `أنت مولد أسئلة ذكي متخصص في أسئلة الاختيار من متعدد للعبة المعلومات العامة. أنشئ 5 أسئلة متنوعة ومثيرة وممتعة باللغة العربية.

متطلبات الأسئلة:
- يجب أن تكون جميع الأسئلة من نوع الاختيار من متعدد فقط
- كل سؤال له 4 خيارات بالضبط (أ، ب، ج، د)
- إجابة واحدة صحيحة فقط لكل سؤال
- أسئلة ممتعة ومناسبة لجميع الأعمار وسهلة الفهم
- تغطي مواضيع متنوعة: العلوم، التاريخ الإسلامي، الجغرافيا العربية، الرياضة، الأدب العربي، التكنولوجيا، الطبيعة، الثقافة العامة
- مستوى صعوبة متوسط - لا صعبة جداً ولا سهلة جداً
- أسئلة واضحة ومباشرة بدون التباس
- تجنب الأسئلة التي تتطلب معرفة تخصصية عميقة

أمثلة على أنواع الأسئلة المطلوبة:
- ما هي عاصمة المغرب؟
- كم عدد أيام السنة الكبيسة؟
- من هو مؤلف كتاب "الأسود يليق بك"؟
- ما هو أكبر المحيطات في العالم؟
...
حيث correct_answer هو رقم الخيار الصحيح (0 للأول، 1 للثاني، 2 للثالث، 3 للرابع)

المواضيع المقترحة: العلوم الطبيعية، التاريخ الإسلامي والعربي، الجغرافيا العربية والعالمية، الرياضة العربية والعالمية، الأدب العربي، التكنولوجيا والابتكار، الطبيعة والحيوانات، الثقافة العامة`;
